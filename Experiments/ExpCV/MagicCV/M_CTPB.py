...
"""
Experiment2: 
Strategy: jDE/current-to-pbest/1
Data:     Magic   
"""
...
for i in range(10):
    ...
    AE = DENN(popSize, n_nodes, activationList, loss, niter, strat, jDE=jDE, p=pp) 
    # do process
...
# =============================================================================
# s.save(models, 'Magic_ctpb') #Experiments/result_magic/CTPB
# =============================================================================
# xxx = s.load('Magic_ctpb.dat') #Experiments/result_magic/CTPB
