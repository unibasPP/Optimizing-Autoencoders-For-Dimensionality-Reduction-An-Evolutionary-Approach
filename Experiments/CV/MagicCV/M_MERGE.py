...
# go to Experiments/reult_Magic/MERGE
#s.save(models, 'Experiments/result_Magic/MERGE/Magic_MERGE')
#xxx = s.load('Experiments/result_Magic/MERGE/Magic_MERGE.dat')
